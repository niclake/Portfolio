'Weather Advice Project
'Tyler Glass
'8/30/2010
'This project allows us to learn several new controls and 
'learn about user interface guidelines
...
Public Class WeatherForm
    ...
    Private Sub printbtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles printbtn.Click
